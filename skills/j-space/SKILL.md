...
| A task matches a playbook under `~/.dsh/skills/learned/`, or you just finished one and the run found a better step or a new failure mode | `modules/learned-skills.md` + that learned `SKILL.md` | The playbook you loaded, and the one edit you will write back |
